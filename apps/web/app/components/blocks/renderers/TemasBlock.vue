    ...
    <div class="container-web">
      ...
      >
        ...
        >
          <UiCard hoverable>
            <template #header>
              <AppImage v-if="item.avatar" :src="item.avatar" :alt="item.name" :width="400" sizes="(max-width: 768px) 50vw, 25vw" :loading="i > 0 ? 'lazy' : 'eager'" class="aspect-[4/3] w-full object-cover" />
            </template>
